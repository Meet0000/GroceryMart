...
const FRUITS_LIST = [
    ...
    { 
        id: "f4",
        name: " Healthy market Blackberries, 170 gm",
    ...
    {
        id : "f7",
        name: "Black or Red Grapes, 1 Bag",
        price: "$3.58 per Bag",
    ...
    { 
        id : "f8",
        name: "Organic Kiwis,Bag size around 1.3 lbs",
        price: "$1.48 each",
    ...
    {
        id: "f9", 
        name: "Imported Indian Kesar Mango",
        price: "$12.52 per box",
    ...
    { 
        id : "f11",
        name: "Fresh Pomegranates, sold per pcs",
        price: "$2.16 per lb",
    ...
    { 
        id: "f15",
        name: "Strawberries Box,around 1.5 lbs",
        price: "$3.98 per box",
...
const DAIRY_LIST = [
    ...
    { 
        id: "d4",
        name: "Gay Lea Salted Butter,425gm",
        price: "$4.87",
    ...
    {
        id : "d6",
        name: "Brar's Malai Paneer,325 gm",
        price: "$5.97",
...
const BAKERY_LIST = [
    {
      ...
      {
        id: "b4",
        name: "CHIPS AHOY! Chocolate Cookies",
        price: "$3.48",
      ...
      {
        id: "b6",
        name: "Cherisews Oreo,origanl 250gm",
        price: "$3.48",
      ...
      {
        id: "b8",
        name: "Banana Bread Chocolate, 8 Pack",
        price: "$4.47",
      ...
      {
        id: "b10",
        name: "Fresh backery two-bite® Brownies",
        price: "$6.00",
      ...
      {
        id: "b13",
        name: "YF Market Chocolate Fudge Cake",
        price: "$6.00",
      ...
      {
        id: "b14",
        name: "Quaker Blueberry Flavour Muffin Mix",
        price: "$5.47",
      ...
      {
        id: "b15",
        name: "Betty Crocker Red Velvet Cupcakes ",
        price: "$3.97",
